from Service.AddNewAnimal import AddNewAnimal
from Service.Counter import Counter
from Service.TechNewCommands import TeachNewCommands
from View.Output import print_animal
